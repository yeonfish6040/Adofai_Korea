package com.yeonfish.adofai_korea.utilTest;
...
public class GoogleSheetTest {
    private final logger log = new logger(true, true);

    @Autowired
    private LevelManageService levelManageService;

    @Test
    public void testReadData() throws GeneralSecurityException, IOException, org.springframework.boot.configurationprocessor.json.JSONException {
        ...
        levelManageService.SyncLevels(levelVO);
    }
}
